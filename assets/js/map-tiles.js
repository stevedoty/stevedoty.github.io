...
function createArticle(item, i){
  ...
  var s = '<span class="image"><img src="'+item.backgroundImg+'" alt="" /></span>    <a><h2>'+item.title+'</h2><div class="content"><img id="project_screenshot" src="'+item.screenShot+'" alt="" /><p>'+item.summary+'</p><button class="tile-button" onclick="'+item.gH+'">Run</button><button class="tile-button" onclick="goTo('+item.gHpages+')">Source</button></div></a>';
  newTile.innerHTML = s;
  return newTile;
}
